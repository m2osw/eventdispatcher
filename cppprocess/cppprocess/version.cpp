...
/** \file
 * \brief The version of the cppprocess at compile time.
 *
 * This file records the cppprocess library version at compile time.
 *
...
/** \def CPPPROCESS_VERSION_MAJOR
 * \brief The major version of the cppprocess library.
 *
 * The major version at compile time.
 */


/** \def CPPPROCESS_VERSION_MINOR
 * \brief The minor version of the cppprocess library.
 *
 * The minor version at compile time.
 */


/** \def CPPPROCESS_VERSION_PATCH
 * \brief The patch version of the cppprocess library.
 *
 * The patch version at compile time.
 */


/** \def CPPPROCESS_VERSION_STRING
...
{
    return CPPPROCESS_VERSION_MAJOR;
}
...
{
    return CPPPROCESS_VERSION_MINOR;
}
...
{
    return CPPPROCESS_VERSION_PATCH;
}
...
{
    return CPPPROCESS_VERSION_STRING;
}
